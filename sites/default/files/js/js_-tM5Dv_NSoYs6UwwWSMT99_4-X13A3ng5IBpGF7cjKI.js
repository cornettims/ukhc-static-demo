...
// // $('#debug').text(viewportHeight);
//     // $('.patient-tools-mobile').css('max-height',`${viewportHeight}px`);
//     $(window).resize(function(){
//         var newHeight = Math.max(document.documentElement.clientHeight, window.innerHeight || 0);
//         viewportHeight = newHeight < viewportHeight ? newHeight: viewportHeight;
...
//todo make patient tools expand based on height of contents
...
jQuery(document).ready(function ($) {
    ...
    $('.doctor-rating .description').each(function () {
        var text = $(this).text();
        ...
        if(characterLength >maxLength){
            ...
            $(this).text(newStr);
            $(this).append("<span class='d-none more-text'>"+removedStr+"</span>");
            $(this).append('<a href="javascript:void(0);" class="read-full-review">Read full review</a>');
        }
    });
    $('.doctor-rating .description .read-full-review').on('click', function(){
