...
jQuery(document).ready(function ($) {
    ...
    $('#toggle-icon').on('click', function () {
        var v = $('.mobile-patient-tools-icon').attr('data-v') >= 3 ? 0 : parseInt($('.mobile-patient-tools-icon').attr('data-v')) + 1;
    ...
    $('.search-icon-top-left-corner.close-icon').on('click', function(){
        $('.patient-tools-container .search-icon').removeClass('close-icon');
            $('.search-modal').removeClass('show');
            $(".dark-overlay").addClass('off');
    });
    ...
    $('.patient-tools-mobile').on('click', function () {
        $(this).toggleClass('open');
        if ($(".dark-overlay").hasClass('off')) {
            $(".dark-overlay").removeClass('off');
        } else {
            $(".dark-overlay").addClass('off');
        }
...
jQuery(document).ready(function ($) {
    console.log("TESTING");
    $('.condition-tab').on('click', function(){
        $('.condition-tab').removeClass('active');
        $(this).addClass('active');
        //data-desktop-width="115" data-desktop-x="410" 
    });
    $('.condition-detail-nav-item').hover(function(){
        console.log('hover');
        var width = $(this).attr('data-desktop-width');
        var left = $(this).attr('data-desktop-x');
        // $('.border-highlight').css({width:width+'px',left:left+"px"});
    },function(){
        var width = $('.condition-detail-nav-item.active').attr('data-desktop-width');
        var left = $('.condition-detail-nav-item.active').attr('data-desktop-x');
        $('.border-highlight').css({width:width+'px',left:left+"px"});
    });
    $('.condition-detail-nav-item').on('click',function(){
        var width = $(this).attr('data-desktop-width');
        var left = $(this).attr('data-desktop-x');
        $('.border-highlight').css({width:width+'px',left:left+"px"});
        $('.condition-detail-nav-item').removeClass('active');
        $(this).addClass('active');
    ...
    if ($('[data-scroll-check="true"]').length) {
        $(window).scroll(function () {
            if ($(window).scrollTop() > 0) {
                ...
                //slide-in
                $('.doctor-name .doctor-title').removeClass('mb-4');
                $('.headshot').removeClass('mb-3');
                // $('.headshot').removeClass('px-5');
                $('.doctor-sidebar-content .doctor-title').css({ "opacity": 0,"height":"100px"});
                $('.doctor-sidebar-content').addClass('scrolled');
            } else {
                $('.headshot').addClass('mb-3');
                // $('.headshot').addClass('px-5');

                $('.doctor-name .doctor-title').addClass('mb-4');
                $('.doctor-sidebar-content .headshot img').css({ "width": "100%" });
                // $('.doctor-sidebar-content .headshot img').css({ "width": "75%", "float": "none" });
                $('.doctor-sidebar-content .doctor-title').css({ "opacity": 1,"height":"initial" });
